...
| `routes/upload.ts`                                                                    | `POST /upload/init`, `/upload/chunk/:uploadId`, `/upload/complete/:uploadId`, `GET /upload/status/:uploadId`, `DELETE /upload/:uploadId`; `consumeUpload()`; 30 min stale sweep                                                                                                                                                                                            |
...
| `routes/files.ts`                                                                     | `GET /storage/stats`, `GET /files/:id/download`; `streamFile()` with single-range support                                                                                                                                                                                                                                                                                  |
