...
export const JobsArea = memo(function JobsArea({
  ...
  return (
    <div className="rounded-md flex flex-col border col-span-full border-kumo-hairline bg-kumo-recessed">
      ...
      <div className="grid grid-cols-4 gap-px border-t border-kumo-hairline bg-kumo-hairline">
