...
- yagni 5 `*Area` shells with identical top-bar/readout-grid/hint skeleton. One `AreaShell`. [components/crop/CropArea.tsx, components/mobile/MobileArea.tsx, components/bulk/BulkArea.tsx, components/subtitles/SubtitleArea.tsx, components/admin/JobsArea.tsx]
